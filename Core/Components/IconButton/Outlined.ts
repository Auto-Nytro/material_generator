...
export interface Outlined {
  ...
  // NOTE: Container is transparent when icon is unselected and disabled.
...
export const create = (): Outlined => {
  return {
    ...
    containerColor: Vars.ColorScheme.OutlineVariant(),
    containerColorUnselected: Vars.ColorScheme.OutlineVariant(),
    containerColorSelected: Vars.ColorScheme.InverseSurface(),
    containerColorSelectedDisabled: Vars.ColorScheme.OnSurface(),

    containerOpacitySelectedDisabled: Ui.create(0.1),
